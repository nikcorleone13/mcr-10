...
const DataProvider = ({ children }) => {
  ...
  const departmentTypes = inventoryData
    .map((item) => item.department)
    .filter(
      (department, index, departmentsArray) =>
        departmentsArray.indexOf(department) === index
    );
  // console.log("total",departmentTypes);
  ...
  const addItemFunction = ({
    ...
    console.log("new item",inventoryData );
